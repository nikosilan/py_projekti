...
flight_count = 32 # Lennot määrä, käytetään sitten maanosien aukeamisessa
continents_sql_list = set() # Alussa on vain Eurooppa, sitten tähän lisätään muita
...
def random_kohteet(yhteys, flight_count):
    destinations = []

    # Haetaan avatut maanosat joka kertaa kun lennetään
