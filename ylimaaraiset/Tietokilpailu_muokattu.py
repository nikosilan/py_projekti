...
def tietokilpailu_peli(pisteet):
    ...
    print(f"\nPelin lopussa ansaitsit yhteensä {saatu_pisteet} pistettä.")
    return saatu_pisteet   # <-- FIX: palautetaan vain uudet pisteet
...
uudet_pisteet = tietokilpailu_peli(pisteet)
update_raha(uudet_pisteet, yhteys)
print(f"Sinulla on nyt {get_raha(yhteys)}€.")
